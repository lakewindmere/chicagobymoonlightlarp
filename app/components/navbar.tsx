      ...
      <nav className="w-full bg-black py-2 px-6 border-b border-zinc-900">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex space-x-8">
            <Link href="/store" className="text-red-700 font-serif text-sm uppercase tracking-widest hover:text-red-500 transition-colors">
              Store
            </Link>
            <Link href="/information" className="text-red-700 font-serif text-sm uppercase tracking-widest hover:text-red-500 transition-colors">
              Information
            </Link>
          </div>
